...
{
    // a DbContext is the communicator between a controller and a DB
    public class NZWalksDbContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Seed difficulties to the database. use the modelBuilder, select the
            // entity and use HasData to insert the data.
            ...
            // in order for this to work, you need to run a migration, with 
            // Add-Migration and then Update-Database in the Pkg Manager Console.
        }
    }
}
